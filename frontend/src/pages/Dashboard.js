...
import FilledProfileData from '../components/FilledUserProfile.js'
function Dashboard() {
  ...
  **/
  const redirectUnauthenticatedUser = () => {
    if (!isUserLoggedIn()) {
      history.push('/signin?next=/dashboard');
    }
  }
  ...
  **/
  ...
  return <>
    ...
    <div class="flex flex-col w-64 h-screen py-8 bg-white border-r dark:bg-gray-800 dark:border-gray-600">
        <h2 class="text-3xl font-semibold text-center text-gray-800 dark:text-white">Printed</h2>
        <FilledProfileData></FilledProfileData>
        <div class="flex flex-col justify-between flex-1 mt-6">
            <nav>
                ...
                <a class="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-200 transform dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                    ...
                    <span class="mx-4 font-medium">New Order</span>
                </a>
